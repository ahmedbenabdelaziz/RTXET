...
class _admiState extends State<admi> {
  ...
  Future<Map<String, dynamic>> getMsgEtudient()async{

    Map<String, String> headers = {
      'Authorization': 'Bearer 51|eYCW2XOPmHI4aWQETVp3kWRhNkaiQ9vOKe8IjjqX',
      'Content-Type': 'application/json',
      'Accept': 'application/json',
    };
    http.Response response = await http.get(Uri.parse('http://192.168.1.13/ISIMM_eCampus/public/api/chat_messages_etudiant/1'),
        headers: headers);
  ...
  void sendMsg(String msg, String sender,chatid) {
    ...
    socket?.emit('sendMsg', {
      ...
      "access_token": '51|eYCW2XOPmHI4aWQETVp3kWRhNkaiQ9vOKe8IjjqX',
      "chat_id": 1,
    });
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            setState(() {
                              print('ahla');
                              sendMsg(_msgController.text, "ahmed",1);
                              _msgController.clear();
