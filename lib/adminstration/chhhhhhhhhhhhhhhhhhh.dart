...
class _chtestState extends State<chtest> {
  ...
  enregistrerMsgEnseignant(String msg, int chatId) async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.1.13/ISIMM_eCampus/public/api/enseignant/contacter_admin'),
      headers: headers,
      body: json.encode({
        'chat_id': 7,
        'text':msg,
  ...
  Future<Map<String, dynamic>> getMsgEtudient(int selectedindex)async{
    ...
    http.Response response = await http.get(Uri.parse('http://192.168.1.13/ISIMM_eCampus/public/api/chat_messages_enseignant/7'),
        headers: headers);
