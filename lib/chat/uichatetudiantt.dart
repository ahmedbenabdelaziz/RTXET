...
class ChatUiet extends StatefulWidget {
  final String token;
  final String image;

  const ChatUiet({Key? key, required this.token, required this.image}) : super(key: key);

  @override
  State<ChatUiet> createState() => _ChatUietState();
}

class _ChatUietState extends State<ChatUiet> {
